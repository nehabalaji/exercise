...
public class NotificationUtils {
    ...
    private static final int ACTION_IGNORE_ID = 3333;
    private static final int ACTION_DRINK_ID = 3334;
    /**
    ...
    public static NotificationCompat.Action ignoreReminderAction(Context context){
        ...
        PendingIntent pendingIntent = PendingIntent.getService(context, ACTION_IGNORE_ID, intent, PendingIntent.FLAG_UPDATE_CURRENT);
        NotificationCompat.Action action = new NotificationCompat.Action(R.drawable.ic_drink_notification, context.getString(R.string.app_name), pendingIntent);
        return action;
    }
    ...
    private static NotificationCompat.Action drinkWaterAction(Context context){
        ...
        PendingIntent pendingIntent = PendingIntent.getService(context, ACTION_DRINK_ID, intent, PendingIntent.FLAG_UPDATE_CURRENT);
        NotificationCompat.Action action = new NotificationCompat.Action(R.drawable.ic_drink_notification, "Drink Water", pendingIntent);
        return action;
    }
