...
public class NotificationUtils {
    ...
    public static int PENDING_INTENT_ID =  3456;
    ...
    public static void remindUserBecauseCharging(Context context){
        ...
        if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            NotificationChannel notificationChannel = new NotificationChannel(WATER_REMINDER_NOTIFICATION_ID,
                    "Main Notification Channel",
                    NotificationManager.IMPORTANCE_HIGH);
        }
        NotificationCompat.Builder nBuilder = new NotificationCompat.Builder(context, WATER_REMINDER_NOTIFICATION_ID)
        ...
        notificationManager.notify(PENDING_INTENT_ID, nBuilder.build());
    }
